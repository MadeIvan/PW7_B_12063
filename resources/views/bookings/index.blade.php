    ...
    <div class="container-fluid"> 
        <div class="row"> 
            <div class="col-12"> 
                <div class="card"> 
                    <div class="card-body"> 
                    <a href="{{ route('bookings.create') }}" class="btn btnmd btn-success mb-3">Tambah Buku</a> 
                        <div class="table-responsive p-0"> 
                            <table class="table table-hover text-no-wrap"> 
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        <td class="text-center"><img src="{{$item->book->poster }}" alt="Poster" width="100" height="150"></td> 
